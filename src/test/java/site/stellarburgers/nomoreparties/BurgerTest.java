...
public class BurgerTest {
    ...
    public void setBuns() {
        ...
        assertEquals("Неверная булочка в бургере", bun, actual);
    }
    ...
    public void addIngredient() {
        ...
        assertEquals("Неверные ингредиенты в бургере", expected, actual);
    }
    ...
    public void removeIngredient() {
        ...
        assertEquals("Неверное удаление ингредиента", List.of(), actual);
    }
    ...
    public void moveIngredient() {
        ...
        assertEquals("Неверное перемещение ингредиента", filling, actual);
    }
    ...
    public void getReceipt() {
        ...
        assertEquals("Неверный рецепт бургера", expected, actual);
    }
}